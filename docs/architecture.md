...
## 7. Week 1 Deliverables (Foundation)

- [x] Monorepo structure
- [ ] TypeScript config and ESLint
- [ ] Prisma schema (PostgreSQL)
- [ ] Content schema validation (TypeScript types)
- [ ] YAML/JSON content directory structure
- [ ] Validation CLI (`pnpm validate-content`)
- [ ] Seed script (import tiny dataset)
- [ ] CI (GitHub Actions for schema + content validation)
- [ ] README + architecture doc
- [ ] `pnpm test`, `pnpm lint`, `pnpm validate-content` all pass
